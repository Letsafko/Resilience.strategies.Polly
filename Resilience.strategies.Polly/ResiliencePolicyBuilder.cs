                ...
                Policy
                    ...
                    .CircuitBreakerAsync(options.ExceptionsAllowedBeforeBreaking,
                        ...
                        (@delegate, duration, context) =>
                        {
                            ...
                            _logger.LogWarning(@delegate.Exception,
                                $"policy: {context.PolicyKey} - durationOfBreak: {duration.Seconds} seconds.");
                        },
                        context =>
                        {
                    ...
                    .WithPolicyKey(Constants.PolicyName.CircuitBreaker)
            };
        }
            ...
            return
                HttpPolicyExtensions
                    ...
                    .WaitAndRetryAsync(
                        ...
                        (@delegate, timespan, retries, context) =>
                        {
                            context[$"{context.PolicyKey}.onRetry.Attempts"] = retries;
                            _logger.LogWarning(@delegate.Exception,
                                $"policy: {context.PolicyKey} - attempt n°: {retries}");
                        })
                ...
                HttpPolicyExtensions
                    ...
                    (
                        ...
                        (@delegate, context) =>
                        {
                            ...
                            _logger.LogWarning(@delegate.Exception,
                                $"policy: {context.PolicyKey} - message: {@delegate.Exception.Message}");
